window.dgspHienThiController = function (
  $scope,
  $http,
  $routeParams,
  $location
  ...
  $scope.loadData = function () {
    $http.get(dangGiaSanPhamApi + "/get-all-hien-thi?page=" + $scope.pageNo).then(
      function (response) {
...
$scope.delete = function (event) {
  ...
  $http.delete(dangGiaSanPhamApi + "/delete/" + $scope.listIdCheck).then(
    function (response) {
...
$scope.getLength = function () {
  $http.get(dangGiaSanPhamApi + "/get-length-tt?by=" + "hienthi").then(
    function (response) {
