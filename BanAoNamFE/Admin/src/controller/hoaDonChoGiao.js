window.hoaDonChoGiaoController = function ($scope, $http ,$timeout ) {
  $scope.listHD = [];
  $scope.listHDHT = [];
  $scope.listHDCT = [];
  ...
  $scope.loadSearchTT = function () {
    ...
    $http
      .get(
        hoaDonApi + "/search-trang-thai?trangThaiS=2&pageNo=" + $scope.pageNo
      )
      .then(
        function (response) {
  ...
  $scope.timKiem = function () {
    $http
      .get(hoaDonApi + "/tim-kiem?trangThai=2&searchByMa=" + $scope.search)
  ...
  $scope.timNgay = function () {
    $http
      .get(
        hoaDonApi +
          "/tim-ngay1?trangThaiSearch=2&ngayTaoSearch=" +
          $scope.searchNgay
      )
      .then(function (response) {
        $scope.listHD = response.data;
  ...
  $scope.timKhoangNgay = function () {
    $http
      .get(
        hoaDonApi +
          "/tim-khoang-ngay1?trangThaiSearch=2&ngayTaoSearch=" +
          $scope.batDau +
          "&ngayTaoSearchs=" +
          $scope.ketThuc
      )
